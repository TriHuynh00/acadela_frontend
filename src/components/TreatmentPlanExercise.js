export const treatmentPlanExercise =
'#aca0.1\n' +
'import extfile.redGreenUiRef as rgu\n' +
'\n' +
'workspace Umcg\n' +
'\n' +
'define case ST1_Hypertension_Example\n' +
"    prefix = 'ST1'\n" +
'    version = 2\n' +
"    label = 'Hypertension Treatment Example'\n" +
'    \n' +
'    Responsibilities\n' +
...
'            InfoPath Treatment.ExampleTask.ExampleField\n' +
'\n' +
...
"        label = 'Treatment'\n" +
'\n' +
'        // Define two Preconditions to express the OR logic between them HERE\n' +
'        Precondition\n' +
"            previousStep = 'Evaluation' \n" +
"            condition = 'Evaluation.RequestMedicalTest.CholesterolTest = 0'\n" +
'        HumanTask ExampleTask\n' +
'            #mandatory\n' +
"            owner = 'Setting.Nurse'\n" +
"            label = 'Example task'    \n" +
'        Form ExampleForm\n' +
'                InputField ExampleField\n' +
'                    #text #left #mandatory\n' +
'                    label = "Blood Cholesterol Level (mm/L):" \n' 